...
La lista completa de archivos se reconstruye con **expand()**, y parámetros como el tipo de análisis se extraen directamente desde el archivo de configuración, manteniendo el pipeline flexible, reproducible y fácil de extender.
