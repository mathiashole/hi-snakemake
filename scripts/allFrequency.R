...
# --------------------------------------------------------------------------
# This file allFrequency is intellectual property of Mathias Mangino and
# is licensed under the MIT License.
#
# Copyright (c) 2024 Mathias Mangino
# See the LICENSE-MyScript.txt file for the full license text.
# -------------------------------------------------------------------------
